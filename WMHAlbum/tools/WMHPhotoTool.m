...
@implementation WMHAlbumList

@end

@implementation WMHPhotoTool

static WMHPhotoTool *sharePhotoTool = nil;
...
- (NSArray<WMHAlbumList *> *)getPhotoAblumList
{
    NSMutableArray<WMHAlbumList *> *photoAblumList = [[NSMutableArray alloc] init];
    ...
    [smartAlbums enumerateObjectsUsingBlock:^(PHAssetCollection * _Nonnull collection, NSUInteger idx, BOOL *stop) {
        ...
        if(collection.assetCollectionSubtype != 202 && collection.assetCollectionSubtype < 212){
            ...
            if (assets.count > 0) {
                WMHAlbumList *ablum = [[WMHAlbumList alloc] init];
                ...
                ablum.albumId = collection.localIdentifier;
...
- (void)getCurrentPhotoBytesWithAsset:(PHAsset *)asset completion:(void (^)(NSString *photosBytes))completion {
